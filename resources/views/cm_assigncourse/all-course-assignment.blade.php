				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<form class="form-horizontal form-label-left" action="#" method="POST" onsubmit="return leadmanagmentController.courseassignment(this)">
						...
						<div class="x_content table-responsive">
							<table id="datatable-assign-course" class="table table-striped table-bordered">
								<thead>
									...
									<?php //echo "<pre>";print_r($assigncourse);die; ?>
									...
									// echo "<pre>";print_r($usersname);
										...
										echo "<span class=\"label label-default\" title='".$coursev->name."'>".substr($coursev->name,0,25)."</span> ";
										}
										}
										} ?></td>
										...
										echo "<span class=\"label label-default\" title='".$coursesv->name."'>".substr($coursesv->name,0,15)."</span> ";
										}
										}
										} ?></td>
									...
									<td>
										...
										<a href="javascript:leadmanagmentController.assigncoursestatus({{$course->id}},'0')"><span style="color:green">Present </span></a>
										
										<?php }else{ ?>
										<a href="javascript:leadmanagmentController.assigncoursestatus({{$course->id}},'1')"><span style="color:red">Absent </span></a>
