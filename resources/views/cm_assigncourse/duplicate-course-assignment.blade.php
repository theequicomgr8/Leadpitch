	...
	<div class="right_col" role="main">
		<div class="">
			...
			<div class="row">
				...
				<!--<div class="col-md-8 col-sm-8 col-xs-8 col-xs-offset-3">
					<div class="x_panel">
						<div class="x_title">
						...
						<div class="x_content table-responsive">
							<table id="datatable-assign-course" class="table table-striped table-bordered">
								<thead>
									<tr>
										<th>Counsellors</th>										 
										<th>Dup Dom Course</th>
										<th>Dup Int Status</th>
										<th>Action</th>
									</tr>
									</thead>
									<tbody >
									...
									// echo "<pre>";print_r($usersname);
										...
										<td><?php  
										if($course->assign_dup_dom_course	 !== NULL){
										$dupassigncourse = unserialize($course->assign_dup_dom_course	);
										foreach($courses as $coursev){
										if(in_array($coursev->id,$dupassigncourse)){
										echo "<span class=\"label label-default\" title='".$coursev->name."'>".substr($coursev->name,0,15)."</span> ";
										}
										}
										} ?></td>
										
										<td><?php  
										if($course->assign_dup_int_course !== NULL){
										$dupIntassigncourse = unserialize($course->assign_dup_int_course);
										foreach($courses as $coursevs){
										if(in_array($coursevs->id,$dupIntassigncourse)){
										echo "<span class=\"label label-default\" title='".$coursevs->name."'>".substr($coursevs->name,0,15)."</span> ";
										}
										}
										} ?></td>
									<!--	<td>
