				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_panel">
						...
						<div class="x_content" id="employee_table">
							<table id="datatable-not_interestedfblead" class="table table-striped table-bordered">
								<thead>
									<tr>
					...
					<div class="row"> 
							...
							<div class="col-md-2" style="display:none;">	<!--//action="{{ url('/lead/getleadsSalesCounsellorTeamexcel') }}"  -->
...
<script type="text/javascript">
	...
	// 	var id=$(this).val();
	// 	if(id=='3'){
	// 		$(".expected_date_time").attr('disabled','disabled');
	// 		$(".expected_date_time").prop('readonly', true);
	// 		$(".expected_date_time").attr('value', '6565');
	// 	}
	// });
</script>
