		...
		<div class="">
			<div class="page-title">
				<div class="title_left">
					<h3>All Expected New Batch  Leads</h3>
				</div>
			</div>
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_panel">
						...
						<div class="x_content" id="employee_table">
							<table id="datatable-expected-new-batch-lead" class="table table-striped table-bordered">
								<thead>
									<tr>
							...
							<form id="export-leads" method="POST" onsubmit="return exportLeads()" action="{{ url('/lead/getleadsexcel') }}">
								...
								<button type="button" class="btn btn-success  btn-block move-not-interested" onclick="javascript:leadController.expectedNewBatchMoveToLead()" >Move Batch To Lead.</button>
