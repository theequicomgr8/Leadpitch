				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_panel">
						...
						<div class="x_content" id="employee_table">
							<table id="datatable-lead-forward" class="table table-striped table-bordered">
								<thead>
									<tr>
					...
					<div class="row"> 
					  <div class="col-md-12"> 							  
							@if (Auth::user()->role =='super_admin')									 
								<div class="col-md-1">	 
								<button type="button" class="btn btn-success  btn-block" onclick="javascript:leadController.selectForwardDelete()" >Delete</button> 
								</div>
