...
@section('content')	
	...
	<div class="right_col" role="main">
							...
							<form method="GET" action="" novalidate autocomplete="off">
								...
								<div class="form-group">
									<div class="col-md-3">
										...
										<input type="text" class="form-control expdf" name="search[expdf]" value="{{ $search['expdf'] or "" }}" placeholder="Follow Date From">
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-3">
										<label>Expected Date To</label>
										<input type="text" class="form-control expdt" name="search[expdt]" value="{{ $search['expdt'] or "" }}" placeholder="Follow Date To">
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-3">
								...
								<div class="form-group">
									<div class="col-md-3">
										...
										<input type="text" class="form-control leaddt" name="search[leaddt]" value="{{ $search['leaddt'] or "" }}" placeholder="Create Date To">
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-3">
						...
						<div class="x_content">
							...
							<form id="export-demos" method="POST" onsubmit="return exportDemos()" action="{{ url('/demo/getdemosexcel') }}">
								...
								@if (Auth::user()->role =='super_admin' || Auth::user()->role =='administrator' ) 
								 <div class="form-group">
								<div class="col-md-2">							 
								<button type="button" class="btn btn-success  btn-block" onclick="javascript:demoController.selectToNewDemos()" >Create New Demos</button>
								</div>
								</div> 
								@endif
								...
								<div class="form-group">
								<div class="col-md-2">					
								<button type="button" class="btn btn-success btn-block move-not-interested" onclick="javascript:demoController.moveToBatchModel()">Move to Batch.</button>								
								</div>								
								</div>
								@endif
		...
		<div id="demoBulkSmsModal" class="modal fade" role="dialog">
			...
			<div id="moveToBatchModel" class="modal fade" role="dialog">
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title">Assign Lead To Batch</h4>
						<div class="assignsuccess" style="color:green"></div>
					</div>
					<div class="modal-body">
						<form action="" method="post">
						<select class="form-control select2-single" id="batch_id" name="batch_id" >
						...
						<div class="form-group" style="padding-top:20px;margin-bottom:0">
							<div class="col-md-3" style="margin:0 auto;float:none;">
								<button type="button" style="background-color:#169f85;color:#fff;" onclick="javascript:demoController.leadAssignToBatch()" class="btn btn-block">Submit</button>
							</div>
							<div class="clearfix"></div>
						</div>
						</form>
