			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_panel">
						...
						<div class="x_content">
							<table id="datatable-expected-demo" class="table table-striped table-bordered">
								<thead>
									<tr>
							...
							<form id="export-demos" method="POST" onsubmit="return exportDemos()" action="{{ url('/demo/getdemosexcel') }}">
								...
								<div class="col-md-2">
						    	@if (Auth::user()->role =='super_admin' || Auth::user()->role =='administrator')
								<button type="button" class="btn btn-success  btn-block move-joined-demos" onclick="javascript:demoController.expectedMoveToDemos()" >Expt Move To Demo</button>
