				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<form id="add-demo-form" class="form-horizontal form-label-left" onsubmit="return demoStudentsController.submit(this)" autocomplete="off">
								{{ csrf_field() }}
								...
								<div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="text" name="mobile" class="form-control col-md-6 col-xs-12" value="{{ old('mobile') }}" placeholder="Enter Mobile" maxlength="10">
							 ...
							 <div class="form-group" hidden>
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select class="form-control demo_owner" name="owner" tabindex="-1" readonly >
								...
								<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12">
										<input type="hidden" name="sub-course" class="form-control col-md-7 col-xs-12" placeholder="Enter Sub Technology">
									</div>
								</div>
								<!--<div class="form-group">
								...
								<input type="hidden" name="counsellor_remark">
								<!--<div class="form-group">
