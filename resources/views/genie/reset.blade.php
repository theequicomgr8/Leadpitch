...
<div class="container">
	...
	<div class="login-name">
		...
		<img src="{{URL::asset('public/assets/images/design.png')}}" style="width: 340px;">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('genie/reset/password') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
								...
								<a class="color-text" href="{{ url('/genie') }}">login</a>
                            </div>
                        </div>
