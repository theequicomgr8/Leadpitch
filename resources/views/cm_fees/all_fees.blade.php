				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_panel">
						...
						<div class="x_content" id="employee_table">
							<table id="datatable-all-fees" class="table table-striped table-bordered">
								<thead>
									<tr>
						...
						@if (Auth::user()->role =='super_admin')									 
								<div class="col-md-2">	 
								<button type="button" class="btn btn-success  btn-block" onclick="javascript:feesManageController.selectFeesDelete()" >Delete</button> 
								</div>
