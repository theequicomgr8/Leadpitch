		...
		<div class="">
			...
			<div class="row">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>Bucket Assign Course</small></h2>
							<div class="clearfix"></div>
						</div>
						<div class="x_content">
						 
							<form class="form-horizontal form-label-left" action="#" method="POST" onsubmit="return bucketAssignController.submit(this)">
								
								<div class="form-group">
									<label class="col-xs-12">Counsellor<span class="required">*</span></label>
									<div class="col-xs-6">
									
										<select class="form-control select2_bucketcounsellor" name="counsellors" tabindex="-1">
									...
									<div class="col-xs-6">									
										<select class="form-control" name="to_counsellor" tabindex="-1">
										 <option value="">Please Counsellor</option>   
										@if(!empty($users))
												@foreach($users as $user)												 
														<option value="{{ $user->id }}">{{ $user->name }}</option>													 
								...
								<div class="form-group">
									...
									<div class="col-xs-5">
										<select id="source" class="form-control sow_bucket_domestice" multiple style="height:200px;">
									...
									<div class="col-xs-5">
										<select id="destination" name="bucket_assign_dom_course[]" class="form-control" multiple style="height:200px;">
										</select>
									</div>
								</div>	
								...
								<div class="form-group">
									...
									<div class="col-xs-5">
										<select id="intsource" class="form-control sow_bucket_international" multiple style="height:200px;">
									...
									<div class="col-xs-5">
										<select id="intdestination" name="bucket_assign_int_course[]" class="form-control" multiple style="height:200px;">
										</select>
									</div>
								</div>
			 ...
			 <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title">
							<h2>Bucket Full Assign Courses</h2>
							<div class="clearfix"></div>
						</div>
						<div class="x_content table-responsive">
							<table id="datatable-bucket-assign" class="table table-striped table-bordered">
								<thead>
									<tr>
										<th>Counsellors</th> 
										<th>To Counsellors</th> 
										<th>Dom Course</th>
							            <th>Int Course</th> 									 
										<th>Action</th>
									</tr>
