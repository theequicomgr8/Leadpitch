...
@section('content')		
	<div class="right_col" role="main">
		<div class="">
			...
			<div class="modal fade" id="addtrainerrequired" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
					<div class="modal-dialog modal-lm">
					<div class="modal-content">
					<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&Chi;</button>
					<h4 class="modal-title" >Add Trainer Required <div class="text-center savejobpost"></div> <div class="text-center errorjobpost"></div></h4>
					</div>
		...
		<div class="row">
				...
				<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-md-7 col-sm-7 col-xs-12">
							<select class="form-control" name="workday" tabindex="-1">
										...
										<option value="Weekday" @if ("Weekday"== old('workday'))
														selected="selected"	
													@else
											{{ (isset($edit_data) && $edit_data->workday =="Weekday" ) ? "selected":"" }} @endif>Week Day</option>
													<option value="Weekend" @if ("Weekend"== old('workday'))
														selected="selected"	
													@else
											{{ (isset($edit_data) && $edit_data->workday =="Weekend" ) ? "selected":"" }} @endif>Week End</option>
													<option value="Fulltime" @if ("Fulltime"== old('workday'))
														selected="selected"	
													@else
											{{ (isset($edit_data) && $edit_data->workday =="Fulltime" ) ? "selected":"" }} @endif>Full Time</option>
					...
					<div class="form-group row">
						...
						<div class="col-md-7 col-sm-7 col-xs-12">
							<select class="form-control" name="training" tabindex="-1">
										...
										<option value="Online"  @if ("Online"== old('training'))
														selected="selected"	
													@else
											{{ (isset($edit_data) && $edit_data->training =="Online" ) ? "selected":"" }} @endif>Online Training</option>
										<option value="Class Rooms"  @if ("Class Rooms"== old('training'))
														selected="selected"	
													@else
											{{ (isset($edit_data) && $edit_data->training =="Class Rooms" ) ? "selected":"" }} @endif>Class Rooms Training</option>										 
					...
					<div class="form-group row">
						<label class="control-label col-md-3 col-sm-3 col-xs-12">Coures Content <span class="required">*</span></label>
						<div class="col-md-7 col-sm-7 col-xs-12">
