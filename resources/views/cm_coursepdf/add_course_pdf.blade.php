							...
							<form class="form-horizontal form-label-left gr"  enctype="multipart/form-data" action="{{url('coursepdf/add')}}" method="post">
								...
								<div class="form-group">
								 ...
								 <!--<div class="form-group image">
									<label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">PDF File <span class="required">*</span></label>
									<div class="col-md-8 col-sm-8 col-xs-12">										 
										 <input type="file" name="course_image[]"  multiple="multiple"  accept=".pdf,.doc, .docx,">
								...
								<div class="form-group image">
									<label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">Doc File <span class="required">*</span></label>
									<div class="col-md-8 col-sm-8 col-xs-12">										 
										 <input type="file" class="form-control col-md-7 col-xs-12" name="course_doc"  accept=".doc, .docx">
										 
										 @if ($errors->has('course_doc'))
										<small class="error alert-danger">{{ $errors->first('course_doc') }}</small>
										@endif
