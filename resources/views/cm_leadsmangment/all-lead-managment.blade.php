				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_panel">
						...
						<div class="x_content" id="employee_table">
							<table id="data-table-All-Received-Leads" class="table table-striped table-bordered">
								<thead>
									<tr role="row">
					...
					<div class="col-md-12"> 
					<div class="col-md-3">
					<form id="export-received-leads" method="POST" onsubmit="return exportReceivedLeads()" action="{{ url('/lead/getleadsreceivedexcel') }}">
					{{ csrf_field() }}
