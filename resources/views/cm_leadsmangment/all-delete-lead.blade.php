				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_panel">
						...
						<div class="x_content" id="employee_table">
							<table id="data-table-All-Delete-Leads" class="table table-striped table-bordered">
								<thead>
									<tr role="row">
								 	 	<th><input type="checkbox" id="check-all" class="check-box"></th>
									<th>Date</th>
									<th>Name</th>
									<th contenteditable>Mobile</th>
									<!--<th>Email</th>-->
									<!--<th>Page Name</th>	-->								 
									<th>Course </th>
									<th>Form</th>
					...
					<div class="col-md-12"> 
					<div class="col-md-3">
					<form id="export-received-leads" method="POST" onsubmit="return exportReceivedLeads()" action="{{ url('/lead/getleadsreceivedDeleteexcel') }}">
					{{ csrf_field() }}
					...
					@if (Auth::user()->role =='super_admin')									 
					<div class="col-md-3">	 
					<button type="button" class="btn btn-success  btn-block" onclick="javascript:leadmanagmentController.selectReceivedDelete()" >Permanent Delete</button> 
					</div>
					@endif	
