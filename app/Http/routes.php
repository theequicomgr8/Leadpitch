...
Route::get('/press','TrainerController@admission');
...
Route::post('/api/sulekhadata', 'Api\SulekhaController@sulekhadata');
...
//seo category lead analaysis
Route::get('/dashboard/seo-categorylead-analysis','SeoCategoryDashboardController@index')->middleware('auth');
Route::get('/lead/get-seo-category-view','SeoCategoryDashboardController@getPaginationCategoryView')->middleware('auth');
Route::get('/lead/seo-getCategoryCourseWiseCountlead/{id}','SeoCategoryDashboardController@getCourseWiseCountlead')->middleware('auth');
Route::get('/lead/seo-getCategoryCourseLead/{id}','SeoCategoryDashboardController@getCourseLead')->middleware('auth');




//Facbook bulk upload
Route::get('/bulkupload/facbook','FacbookLeadController@createBulkUpload'); 
Route::post('/bulkupload/facbook','FacbookLeadController@storeBulkUpload'); 
Route::post('/facbook/downloadexcelformate','FacbookLeadController@downloadExcelFormate');
//Facbook All Leads
Route::get('/dashboard/facbook-lead','FacbookController@index')->middleware('auth');
Route::get('/lead/getfbleads','FacbookController@getPaginatedLeads')->middleware('auth');



Route::get('/lead/fbadd-lead','FacbookController@create')->middleware('auth');
Route::post('/lead/fbadd-lead','FacbookController@store')->middleware('auth');
Route::get('/lead/fbdelete/{id}','FacbookController@destroy')->middleware('auth');
Route::get('/lead/fbfollow-up/{id}','FacbookController@followUp')->middleware('auth');
Route::get('/lead/fbgetfollowups/{id}','FacbookController@getFollowUps')->middleware('auth');
Route::post('/lead/store-fbfollow-up/{id}','FacbookController@storeFollowUp')->middleware('auth');
Route::get('/fblead/sendmail/{id}','FacbookController@sendMailToCounsellor')->middleware('auth');
Route::post('/lead/send-fbbulk-sms','FacbookController@sendBulkSms')->middleware('auth');
Route::post('/fblead/move-not-interested','FacbookController@moveNotInterested')->middleware('auth');
Route::post('/fblead/move-to-expected-lead','FacbookController@moveToExpectedLead')->middleware('auth');
Route::post('/fblead/move-to-lead','FacbookController@moveToLeads')->middleware('auth');
Route::post('/fblead/expected-move-to-lead','FacbookController@expectedMoveToLeads')->middleware('auth');
Route::post('/fblead/expected-new-batch-move-to-lead','FacbookController@expectedNewBatchMoveToLeads')->middleware('auth');
Route::post('/fblead/move-to-expected-lead-demo','FacbookController@moveToExpectedLeadDemo')->middleware('auth');
Route::post('/fblead/expected-demo-move-to-lead','FacbookController@expectedDemoMoveToLeads')->middleware('auth');
Route::post('/fblead/delete-move-to-lead','FacbookController@deleteMoveToLeads')->middleware('auth');
Route::post('/fblead/expected-demo-move-to-demo-lead','FacbookController@expectedDemoMoveToDemoLeads')->middleware('auth');
Route::post('fblead/selectDelete','FacbookController@selectDelete')->middleware('auth');
Route::post('fblead/selectForwardDelete','FacbookController@selectForwardDelete')->middleware('auth');
Route::post('fblead/selectMailerDelete','FacbookController@selectMailerDelete')->middleware('auth');
Route::post('fblead/selectFeedbackDelete','FacbookController@selectFeedbackDelete')->middleware('auth');
Route::post('fblead/counsellorFeedbackDelete','FacbookController@counsellorFeedbackDelete')->middleware('auth');
Route::post('fblead/selectToNewLeads','FacbookController@selectToNewLeads')->middleware('auth');
Route::get('/fblead/expect-follow-up/{id}','FacbookController@expectfollowUp')->middleware('auth');
Route::get('/fblead/getexpectfollowups/{id}','FacbookController@getExpectFollowUps')->middleware('auth');
Route::get('/fblead/store-expect-follow-up/{id}','FacbookController@storeExpectFollowUp')->middleware('auth');
Route::get('/fblead/leadjoindededit/{id}','FacbookController@leadjoindededit')->middleware('auth');
Route::get('/fblead/storeleadjoind/{id}','FacbookController@storeleadjoind')->middleware('auth');
Route::get('fblead/lead-forward-form/{id}','FacbookController@leadForwardForm')->middleware('auth');
Route::get('/fblead/store-lead-forward/{id}','FacbookController@storeLeadForward')->middleware('auth');

Route::post('/fblead/getleadsexcel','FacbookController@getLeadsExcel')->middleware('auth');

Route::get('/fblead/update/{id}','FacbookController@edit')->middleware('auth');
Route::post('/fblead/update/{id}','FacbookController@update')->middleware('auth');

Route::get('/facbook-lead-manual','FacbookController@leadassign')->middleware('auth');




//facbook not intersted
Route::get('notInter/facbook','FacbookController@notInterested')->middleware('auth');
Route::get('/lead/notIntergetfbleads','FacbookController@notInterestedPagination')->middleware('auth');
...
//facbook unassigned
Route::get('fblead/not-lead-assignment','FacbbokLeadManagmentController@notleadassignmentindex')->middleware('auth');
// Route::get('/facbooklead/get-counsellor-view','FacbbokLeadManagmentController@getPaginationCounsellorView')->middleware('auth');
Route::get('/facbooklead/get-all-not-lead-assignment','FacbbokLeadManagmentController@getNotLeadAssignmentPagination')->middleware('auth');


Route::post('/call','FacbookController@call')->middleware('auth');
Route::get('/calllog/{id?}','FacbookController@calllog')->middleware('auth');


//duplicate facebook
Route::get('fblead/all-duplicate-lead','FacbbokLeadManagmentController@duplicateleadindex')->middleware('auth');
Route::get('fblead/get-all-duplicate-leads','FacbbokLeadManagmentController@getDuplicateLeadPagination')->middleware('auth');
Route::get('fblead/lead-assign-form/{id}','FacbbokLeadManagmentController@leadAssignForm')->middleware('auth');
Route::get('/fblead/store-lead-assign/{id}','FacbbokLeadManagmentController@storeLeadAssign')->middleware('auth');
Route::post('fblead/selectReceivedSoftDelete','FacbbokLeadManagmentController@selectReceivedSoftDelete')->middleware('auth'); 

Route::get('/sk1','HomesController@website');
